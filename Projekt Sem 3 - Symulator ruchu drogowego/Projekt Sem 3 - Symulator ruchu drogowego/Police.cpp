...
Police::Police(sf::Vector2f _pos, sf::Vector2f headingN, float _maxV, float _a)
{
	//Turning variables
	...
	//Texture and sprite
	static sf::Texture texturePolice = []() {sf::Texture t; t.loadFromFile("Sprites/Vehicles/Police.png"); return t; }();
	size = sf::Vector2f(118, 224);
	sprite = new sf::Sprite(texturePolice, sf::IntRect(sf::Vector2i(64, 12), (sf::Vector2i)size));
